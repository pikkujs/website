...
This release marks a turning point: **Pikku is no longer just a function runtime — it’s a complete platform for building scalable, typed, multi-transport backends**. Whether you're targeting HTTP, queues, RPCs, or even AI agents — you now write your logic once, then connect it anywhere.
...
We consider Pikku 0.8 **feature-complete**.

Over the next few weeks, we’ll focus on:
