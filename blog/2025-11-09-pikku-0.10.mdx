...
📚 **[View CLI examples →](/?wiring=cli#code-examples)** • **[CLI docs →](https://pikku.dev/docs/wiring/cli)**
...
📚 **[Learn more → Tree-Shaking and Filtering](https://pikku.dev/docs/philosophy/tree-shaking)**
