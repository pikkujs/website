...
export const HttpIcon: React.FC<WiringIconProps> = ({ className = "", size = 16 }) => (
  <div className={`inline-flex items-center justify-center ${className}`} style={{ width: size, height: size }}>
    <svg width={size} height={size} viewBox="0 0 32 32" className="wiring-icon" fill="currentColor">
...
export const WebSocketIcon: React.FC<WiringIconProps> = ({ className = "", size = 16 }) => (
  <div className={`inline-flex items-center justify-center ${className}`} style={{ width: size, height: size }}>
    <svg width={size} height={size} viewBox="0 -31.5 256 256" className="wiring-icon" fill="currentColor">
...
export const SSEIcon: React.FC<WiringIconProps> = ({ className = "", size = 16 }) => (
  <div className={`inline-flex items-center justify-center ${className}`} style={{ width: size, height: size }}>
    <svg width={size} height={size} viewBox="0 0 16 16" className="wiring-icon">
...
export const CronIcon: React.FC<WiringIconProps> = ({ className = "", size = 16 }) => (
  <div className={`inline-flex items-center justify-center ${className}`} style={{ width: size, height: size }}>
    <svg width={size} height={size} viewBox="0 0 24 24" className="wiring-icon" fill="none">
...
export const QueueIcon: React.FC<WiringIconProps> = ({ className = "", size = 16 }) => (
  <div className={`inline-flex items-center justify-center ${className}`} style={{ width: size, height: size }}>
    <svg width={size} height={size} viewBox="0 0 48 48" className="wiring-icon" fill="currentColor">
...
export const MCPIcon: React.FC<WiringIconProps> = ({ className = "", size = 16 }) => (
  <div className={`inline-flex items-center justify-center ${className}`} style={{ width: size, height: size }}>
    <svg width={size} height={size} viewBox="0 0 24 24" className="wiring-icon" fill="currentColor">
