      ...
      <header className="flex max-w-screen-xl mx-auto w-full pt-12 pb-10 lg:pt-16 lg:pb-14 px-6 gap-12 items-center">
        <div className="md:w-1/2">
          ...
          <Heading as="h1" className="font-jakarta text-5xl font-bold mb-4 leading-tight">
            ...
            <span className="text-primary">has the same problem.</span>
          </Heading>
          ...
          <div className="flex flex-row gap-4">
            <a href="#the-loop" className="bg-primary text-black hover:bg-primary px-6 py-3 rounded-lg font-semibold text-base transition-all hover:scale-105 shadow-lg shadow-black/20 no-underline">See the Problem</a>
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-14">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            The AI agent loop that <span className="text-primary">never stops</span>
          </Heading>
                ...
                >
                  <div className={`flex items-center gap-2 px-3 py-2 rounded-lg border ${
                    ...
                    <span className={`flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-bold ${
                      isLoop ? 'bg-white/20 text-red-400' : 'bg-white/8 text-primary'
                    }`}>
                      {step.icon}
                    </span>
        ...
        <p className="text-sm text-neutral-500 mt-10 max-w-xl">
    ...
    <section className="py-20 lg:py-32 relative">
      ...
      <div className="max-w-screen-lg mx-auto px-6 relative">
        <Heading as="h2" className="font-jakarta text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
          ...
          had to think <span className="text-primary">once</span>?
        </Heading>
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        ...
        <div className="max-w-3xl mt-12 bg-white/[0.04] border border-white/12 rounded-xl p-6 ">
          <p className="text-neutral-300 text-base leading-relaxed">
            <span className="text-primary font-semibold">The AI's job is to think, not to execute.</span> After the first run, the workflow is saved. Every subsequent run costs zero tokens, has zero AI latency, and has zero security surface from LLM decisions.
          </p>
        </div>
      </div>
    </section>
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-14">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            ...
            <span className="text-primary">Pikku's don't.</span>
          </Heading>
          <p className="text-lg text-neutral-400 max-w-2xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-3xl mt-12">
          {[
            { icon: <TrendingDown className="w-6 h-6 text-primary" />, value: '$14,399', label: 'saved per year', desc: 'On a single workflow' },
            { icon: <Zap className="w-6 h-6 text-primary" />, value: '~0ms', label: 'AI latency after first run', desc: 'Native execution speed' },
            { icon: <DollarSign className="w-6 h-6 text-primary" />, value: '99.99%', label: 'fewer tokens', desc: 'At any scale' },
          ].map((item, i) => (
            <div key={i} className="bg-[#0d0d0d] border border-neutral-800 rounded-xl p-6 ">
        ...
        <p className="text-neutral-400 text-sm mt-10 max-w-2xl">
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-14">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            ...
            <span className="text-primary">Every step. Every workflow.</span>
          </Heading>
          <p className="text-lg text-neutral-400 max-w-2xl">
        ...
        <div className="max-w-3xl mt-10 bg-white/[0.04] border border-white/12 rounded-xl p-6">
          <p className="text-neutral-300 text-sm leading-relaxed ">
            <span className="text-primary font-semibold">This is why "no LLM in the loop" matters for security.</span> When a workflow runs natively, there's no AI making decisions about which tools to call or what data to access. It follows the exact approved graph — with the exact permissions of the user who triggered it.
          </p>
        </div>
      </div>
    </section>
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-14">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            ...
            <span className="text-primary">no attack surface.</span>
          </Heading>
          <p className="text-lg text-neutral-400 max-w-2xl">
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-14">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            ...
            <span className="text-primary">workflow steps.</span>
          </Heading>
          <p className="text-lg text-neutral-400 max-w-2xl">
          ...
          {addons.map((addon, i) => (
            <div key={i} className="bg-[#0d0d0d] border border-neutral-800 rounded-xl p-6 ">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-9 h-9 rounded-lg bg-white/[0.06] border border-white/12 flex items-center justify-center">
                  {addon.icon}
                </div>
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-14">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            ...
            <span className="text-primary">Every workflow. Every approval.</span>
          </Heading>
          <p className="text-lg text-neutral-400 max-w-2xl">
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-14">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            ...
            <span className="text-primary">version-controlled TypeScript.</span>
          </Heading>
          <p className="text-lg text-neutral-400 max-w-2xl">
        ...
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-0 mb-12">
            {[
              { label: 'Runtime Graph', desc: 'Agent-created, stored in DB', color: 'text-white/55', bg: 'bg-white/[0.06] border-white/12' },
              { label: 'Pikku Graph', desc: 'Pulled into your codebase', color: 'text-white/55', bg: 'bg-white/[0.06] border-white/12' },
              { label: 'Pikku DSL', desc: 'Full imperative TypeScript', color: 'text-white/55', bg: 'bg-white/[0.06] border-white/12' },
            ].map((stage, i) => (
              <React.Fragment key={i}>
                <div className={`${stage.bg} border rounded-xl px-6 py-4 min-w-[180px]`}>
    ...
    <section className="py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="max-w-screen-xl mx-auto px-6 relative">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link to="/docs/wiring/ai-agents" className="bg-primary text-black hover:bg-primary px-8 py-3 rounded-lg font-semibold text-lg transition-all hover:scale-105 shadow-lg shadow-black/20">Read the Docs</Link>
