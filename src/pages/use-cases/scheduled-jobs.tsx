      ...
      <div className="max-w-3xl px-6">
        ...
        <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] overflow-hidden shadow-lg shadow-black/20">
          ...
          <div className="p-5 font-mono text-[12px] leading-6">
            <div className="text-white/30">generateReport — <span className="text-primary">0 9 * * 1</span></div>
            <div className="mt-2" />
            <div className="text-primary">  ✓ Mon Mar 24  09:00:01  <span className="text-white/20">1.4s  success</span></div>
            <div className="text-primary">  ✓ Mon Mar 17  09:00:00  <span className="text-white/20">1.2s  success</span></div>
            <div className="text-primary">  ⟳ Mon Mar 10  09:00:01  <span className="text-white/20">retry 1 → 1.8s  success</span></div>
            <div className="text-primary">  ✓ Mon Mar 03  09:00:00  <span className="text-white/20">1.1s  success</span></div>
          </div>
        </div>
      </div>
    </section>
