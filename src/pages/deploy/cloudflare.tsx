    ...
    <div className="wire-hero-cloudflare w-full relative overflow-hidden">
      ...
      <header className="flex max-w-screen-xl mx-auto w-full pt-12 pb-10 lg:pt-16 lg:pb-14 px-6 gap-12 items-center">
        ...
        <div className="hidden md:flex md:w-1/2 items-center justify-center">
          <div className="bg-[#0d0d0d] border-2 border-white/15 rounded-2xl p-8 font-mono text-sm leading-relaxed max-w-md w-full">
            ...
            <span className="text-primary">Build complete.</span>{' '}
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-14">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            Three commands. <span className="text-primary">Full control.</span>
          </Heading>
        ...
        <div className="grid lg:grid-cols-3 gap-5 max-w-5xl">
          <CodeCard filename="pikku deploy info" icon={<Terminal className="w-4 h-4 text-primary" />}>
...
Secrets:
  ...
  STRIPE_KEY          bound to api-create-order`}</CodeBlock>
          ...
          <CodeCard filename="pikku deploy plan" icon={<Layers className="w-4 h-4 text-primary" />}>
...
3 to create, 1 to update, 1 to delete`}</CodeBlock>
          ...
          <CodeCard filename="pikku deploy apply" icon={<Zap className="w-4 h-4 text-primary" />}>
    ...
    <section className="py-16 lg:py-24 relative">
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-12">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            Everything your app needs. <span className="text-primary">Auto-configured.</span>
          </Heading>
    ...
    <section className="py-16 lg:py-24 relative">
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-12">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            Three things. <span className="text-primary">That's it.</span>
          </Heading>
          <p className="text-lg text-neutral-400 max-w-2xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mb-10">
          {[
            ...
            <div key={i} className="bg-[#0d0d0d] border border-neutral-800 rounded-xl p-5">
              ...
              <div className="text-xs font-mono bg-neutral-900/60 border border-neutral-800 rounded-lg px-3 py-2 text-white/65">
                $ {item.code}
              </div>
            </div>
          ))}
  ...
  return (
    <section className="py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="max-w-screen-xl mx-auto px-6 relative">
        ...
        >
          <span className="text-white/55 select-none">$ </span>{installCmd}
          <button
