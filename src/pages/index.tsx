...
wireGateway({
  ...
  func: handleMessage, // same handler, different platform
    ...
    },
    {
      ...
      summary: 'Compile-time inspection generates clients, OpenAPI docs, and tooling from your system.',
      code: `# Generate types, clients, and metadata
$ npx pikku

# Watch mode — regenerate on changes
$ npx pikku watch

# Launch visual control plane
$ npx pikku console

# Filter by tags or wiring types
$ npx pikku --tags public,api --types http,rpc`,
    },
  ];
