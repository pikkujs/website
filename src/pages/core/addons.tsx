        ...
        <div className="md:w-1/2">
          ...
          <div className="flex flex-row gap-4">
            <Link
              ...
              className="bg-primary text-white hover:bg-primary px-6 py-3 rounded-lg font-semibold text-base transition-all hover:scale-105 shadow-lg shadow-indigo-500/20"
            >
              Using Addons
            </Link>
            <Link
...
function ConsumingSection() {
  const features = [
    {
      icon: <Tag className="w-5 h-5 text-primary mt-0.5 shrink-0" />,
    ...
    {
      icon: <Check className="w-5 h-5 text-primary mt-0.5 shrink-0" />,
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-12">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            Install. Wire. <span className="text-primary">Done.</span>
          </Heading>
...
function CreatingSection() {
  const steps = [
    {
      icon: <Package className="w-5 h-5 text-primary mt-0.5 shrink-0" />,
    ...
    {
      icon: <Puzzle className="w-5 h-5 text-primary mt-0.5 shrink-0" />,
    ...
    {
      icon: <Upload className="w-5 h-5 text-primary mt-0.5 shrink-0" />,
      title: 'Publish & share',
    ...
    <section className="py-16 lg:py-24 relative">
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-12">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            Build your own <span className="text-primary">plugin</span>
          </Heading>
          <p className="text-lg text-neutral-400 max-w-xl">
    ...
    <section className="py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="max-w-screen-xl mx-auto px-6 relative">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link
            to="/docs/addon/consuming"
            className="bg-primary text-white hover:bg-primary px-8 py-3 rounded-lg font-semibold text-lg transition-all hover:scale-105 shadow-lg shadow-indigo-500/20"
          >
