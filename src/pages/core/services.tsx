...
// An illustrative literal rather than a template snippet: the online-shop
// template has the runtime inject `kysely`, so it no longer constructs a dialect
// and has no dynamic-import site to mark. The pattern still applies to any
// service a cold start can skip.
