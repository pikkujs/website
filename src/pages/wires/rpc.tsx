  ...
  return (
    <div className="wire-hero-rpc w-full relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none" aria-hidden>
        <div className="absolute right-[18%] top-1/2 -translate-y-1/2 w-[420px] h-[420px] rounded-full bg-white/12 blur-[100px]" />
      ...
      <header className="flex max-w-screen-xl mx-auto w-full pt-12 pb-10 lg:pt-16 lg:pb-14 px-6 gap-12 items-center">
        <div className="md:w-1/2">
          <span className="inline-block text-xs font-semibold tracking-widest uppercase text-blue-400 border border-white/12 bg-white/10 px-3 py-1 rounded mb-6">
            Wire Type: RPC
          </span>
        ...
        <div className="hidden md:flex md:w-1/2 items-center justify-center">
          <div className="relative">
            <div className="absolute inset-0 bg-white/20 rounded-full blur-[40px]" />
            <div className="relative bg-[#0d0d0d] border-2 border-white/12 rounded-2xl p-6">
              <RPCIcon size={120} />
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mt-10">
          {[
            ...
            <div key={i} className="flex items-start gap-3">
              <span className="flex-shrink-0 w-5 h-5 rounded-full bg-white/20 flex items-center justify-center text-blue-400 text-[11px] font-bold mt-0.5">✓</span>
              <div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1.5">
                      ...
                      <span className="text-xs font-mono px-1.5 py-0.5 rounded bg-white/10 text-blue-400">{m.tag}</span>
                    </div>
...
function CTASection() {
  ...
  return (
    <section className="py-16 lg:py-24 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none" aria-hidden>
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[250px] rounded-full bg-white/8 blur-[80px]" />
      </div>
      <div className="max-w-screen-xl mx-auto px-6 relative">
        ...
        <div className="bg-white/5 border border-white/10 text-white p-4 rounded-xl font-mono text-base max-w-sm relative group cursor-pointer hover:bg-white/8 hover:border-white/12 transition-all mb-10" onClick={copyToClipboard}>
