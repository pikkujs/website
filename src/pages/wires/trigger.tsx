      ...
      <header className="flex max-w-screen-xl mx-auto w-full pt-12 pb-10 lg:pt-16 lg:pb-14 px-6 gap-12 items-center">
        <div className="md:w-1/2">
          ...
          <p className="text-xl font-medium leading-relaxed mb-8 text-neutral-300 max-w-lg">
            <code className="text-primary text-lg">wireTrigger</code> connects external event sources — Redis pub/sub, Postgres changes, polling — to your Pikku functions.
          </p>
          <div className="flex flex-row gap-4">
            <Link to="/docs/wiring/triggers" className="bg-primary text-black hover:bg-primary px-6 py-3 rounded-lg font-semibold text-base transition-all hover:scale-105 shadow-lg shadow-amber-500/20">Get Started</Link>
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-12">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            Two-part <span className="text-primary">pattern</span>
          </Heading>
    ...
    <section className="py-16 lg:py-24 relative">
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-12">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            Subscribe to <span className="text-primary">anything</span>
          </Heading>
...
function LifecycleSection() {
  const steps = [
    { phase: 'Setup', desc: 'TriggerService starts. Each source function runs, subscribes to its event source.', color: 'text-white/55' },
    { phase: 'Fire', desc: 'External event occurs. trigger.invoke(data) dispatches to the target function via RPC.', color: 'text-white' },
    { phase: 'Teardown', desc: 'triggerService.stop() calls each source\'s cleanup function. Connections closed gracefully.', color: 'text-white/55' },
  ];
    ...
    <section className="py-16 lg:py-24">
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-12">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            Setup, fire, <span className="text-primary">teardown</span>
          </Heading>
          <p className="text-lg text-neutral-400 max-w-xl">
          ...
          <div className="space-y-4">
            {steps.map((step, i) => (
              <div key={i} className="flex items-start gap-4">
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-white/8 flex items-center justify-center">
  ...
  return (
    <section className="py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="max-w-screen-xl mx-auto px-6 relative">
        ...
        <p className="text-lg text-neutral-400 mb-10 max-w-xl">One command to scaffold a project with trigger wiring already configured.</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link to="/docs/wiring/triggers" className="bg-primary text-black hover:bg-primary px-8 py-3 rounded-lg font-semibold text-lg transition-all hover:scale-105 shadow-lg shadow-amber-500/20">Read the Trigger Docs</Link>
