      ...
      <header className="flex max-w-screen-xl mx-auto w-full pt-12 pb-10 lg:pt-16 lg:pb-14 px-6 gap-12 items-center">
        <div className="md:w-1/2">
          ...
          <p className="text-xl font-medium leading-relaxed mb-8 text-neutral-300 max-w-lg">
            Add <code className="text-primary text-lg">mcp: true</code> to any Pikku function and it becomes an MCP tool. Resources and prompts use dedicated function types — all exposed automatically via the Model Context Protocol.
          </p>
          <div className="flex flex-row gap-4">
            <Link to="/docs/wiring/mcp" className="bg-primary text-white hover:bg-primary px-6 py-3 rounded-lg font-semibold text-base transition-all hover:scale-105 shadow-lg shadow-pink-500/20">Get Started</Link>
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-12">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            Tools, resources, <span className="text-primary">prompts</span>
          </Heading>
    ...
    <section className="py-16 lg:py-24 relative">
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-12">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            Dynamic control <span className="text-primary">at runtime</span>
          </Heading>
          <p className="text-lg text-neutral-400 max-w-xl">
            Every MCP function gets a <code className="text-primary">wire.mcp</code> object to notify resource changes and toggle capabilities.
          </p>
        </div>
  ...
  return (
    <section className="py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="max-w-screen-xl mx-auto px-6 relative">
        ...
        <p className="text-lg text-neutral-400 mb-10 max-w-xl">One command to scaffold a project with MCP wiring already configured.</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link to="/docs/wiring/mcp" className="bg-primary text-white hover:bg-primary px-8 py-3 rounded-lg font-semibold text-lg transition-all hover:scale-105 shadow-lg shadow-pink-500/20">Read the MCP Docs</Link>
