      ...
      <header className="flex max-w-screen-xl mx-auto w-full pt-12 pb-10 lg:pt-16 lg:pb-14 px-6 gap-12 items-center">
        <div className="md:w-1/2">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="inline-block text-xs font-semibold tracking-wide uppercase text-green-300/70 bg-white/10 border border-white/12 px-3 py-1 rounded-full">
              New
            </span>
          </div>
          <Heading as="h1" className="font-jakarta text-5xl font-bold mb-4 leading-tight">
            ...
            <span className="text-primary">one handler.</span>
          </Heading>
          <p className="text-xl font-medium leading-relaxed mb-8 text-neutral-300 max-w-lg">
            <code className="text-primary text-lg">wireGateway</code> connects your Pikku functions to WhatsApp, Slack, Telegram, and any messaging platform — with normalized messages, auto-verification, and the same middleware you already use.
          </p>
          <div className="flex flex-row gap-4">
            <Link to="/docs/wiring/gateway" className="bg-primary text-white hover:bg-primary px-6 py-3 rounded-lg font-semibold text-base transition-all hover:scale-105 shadow-lg shadow-black/20">Get Started</Link>
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-12">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            Wire a <span className="text-primary">gateway</span>
          </Heading>
...
function TransportTypesSection() {
  const transports = [
    {
      icon: <Webhook className="w-5 h-5 text-primary mt-0.5 shrink-0" />,
      title: 'Webhook',
    ...
    <section className="py-16 lg:py-24">
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-12">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            Three ways to <span className="text-primary">connect</span>
          </Heading>
...
function FeaturesSection() {
  const features = [
    ...
    {
      icon: <Plug className="w-5 h-5 text-primary mt-0.5 shrink-0" />,
    ...
    <section className="py-16 lg:py-24">
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="mb-12">
          ...
          <Heading as="h2" className="font-jakarta text-4xl md:text-5xl font-bold text-white mb-4">
            Adapters, verification, <span className="text-primary">context</span>
          </Heading>
          <p className="text-lg text-neutral-400 max-w-xl">
  ...
  return (
    <section className="py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="max-w-screen-xl mx-auto px-6 relative">
        ...
        <p className="text-lg text-neutral-400 mb-10 max-w-xl">One handler for every messaging platform. No platform-specific boilerplate.</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link to="/docs/wiring/gateway" className="bg-primary text-white hover:bg-primary px-8 py-3 rounded-lg font-semibold text-lg transition-all hover:scale-105 shadow-lg shadow-black/20">Read the Gateway Docs</Link>
