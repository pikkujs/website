...
- [PKU575: Tag Resolves to No Middleware](./pku575.md) — a declared tag that registers no middleware
- [PKU124: Invalid Value](./pku124.md) — other statically-invalid wiring values
