...
https://github.com/pikkujs/yarn-workspace-starter/blob/main/apps/cli/pikku.config.json
```

The example code seen above can be viewed here:

```typescript reference title="fetch.ts"
https://github.com/pikkujs/yarn-workspace-starter/blob/main/apps/cli/bin/fetch.ts
```
