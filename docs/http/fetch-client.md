...
https://raw.githubusercontent.com/pikku/workspace-starter/blob/master/apps/cli/pikku.config.json
```

The example code seen above can be viewed here:

```typescript reference title="fetch.ts"
https://raw.githubusercontent.com/pikku/workspace-starter/blob/master/apps/cli/bin/fetch.ts
```
